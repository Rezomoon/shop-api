...
SECRET_KEY = 'django-insecure-q1y@woxle^9uam@=x95tzlb9k^wymx7&54w5zr0-@v0znnm)=!'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # Hatman bayad aval bashad ya ghabl az common middleware bashad 
